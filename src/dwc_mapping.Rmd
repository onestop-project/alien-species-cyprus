...
```{r read_source_data}
raw_data <- read_csv("https://docs.google.com/spreadsheets/d/e/2PACX-1vS4lRo5BCtdjV_Razg38YvWZvJB73pT8GGCVzYRDAdjAF-rceym3dR-x50e_AtXehKqg9Q_hS4oWWT7/pub?gid=818849950&single=true&output=csv", show_col_types = FALSE)
```
...
```{r}
write_csv(raw_data, here("data", "raw", "raw_data"), na = "")
```
